            ...
            boolean round1 =true;
                    while(allList.size()>0){
                        if(round1){
                                        ...
                                        if (element_monsterList == "monster1"){
                                            ...
                                            System.out.println("and take damage "+hunter.getAttack() + element_monsterList+"reste health:"+ monster1Monster.getHealth());
                                                if (monster1Monster.getHealth()<=0){
                                                    ...
                                                    monsterList.remove(element_monsterList);
                                                }       
                            ...
                            System.out.println("1)increase attack 2)increase defense 3)increase the number of potion 4)increase the number of food 5)increase the domage of potion 6) increase the damage of food 7)increase the number of arrow(jusfor Hunter!) 8)reduce mana cost 9) increse damage of hit 10) increase damage of magic 11)increase dammage of spanich");
